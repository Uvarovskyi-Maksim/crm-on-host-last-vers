    ...
    return status(statusType)
      ...
      .map((client) => (
        ...
        >
          ...
          <div
            className={`date_name_block ${hasUncompletedTaskToday.some((el) => el.email === client.email) ? "uncompleted_tasks" : ""
              }`}
            id={`${taskToday.some((el) => el.email === client.email) ? "today_tasks" : "asd"}`}
          >
